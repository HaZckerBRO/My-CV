...
window.onload = new function(){
	...
	function translatePart_2(lang){
		const skillsTitle = part_2.querySelector('.skills__title'),
	...
	function translateModal(lang){
		const shortInfoBlock = document.querySelector('.short-info');
		const shortInfoTitle = shortInfoBlock.querySelector('.title');
		const experienceTitle = shortInfoBlock.querySelector('.my-skills--experience > .title');
		const otherTitle = shortInfoBlock.querySelector('.my-skills--other > .title');
		const contactsTitle = shortInfoBlock.querySelector('.short-info__footer > .title');
		const otherP = shortInfoBlock.querySelectorAll('.my-skills--other > p');
